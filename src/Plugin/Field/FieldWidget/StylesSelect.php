 ...
 *
 * @FieldWidget(
 *   id = "customeredit_page_label",
 *   label = @Translation("Label"),
 *   description = @Translation("A customer edit page label widget."),
 *   field_types = {
 *     "customeredit_page"
 *   }
 * )
 */
class StylesSelect extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    $storage = \Drupal::service('customeredit.pages.storage');
    $value = isset($items[$delta]->value) ? $items[$delta]->value : '';
    $page = new CustomerPage($value);
    $options = ['_none' => '- Generate -', $value => $page->getTitle()];
    ...
    $element['page'] = [
      '#type' => 'select',
      '#default_value' => ($value) ? $value : '_none',
      '#options' => array_merge($options, $storage->getNotUsedTitles()),
